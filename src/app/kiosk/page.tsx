          ...
          <div className='flex flex-col justify-between px-4 '>
            ...
            <div className='mb-4 mr-0 flex flex-1 flex-col gap-8 rounded-lg bg-white p-8 shadow-md md:flex-row'>
              ...
              <div className='flex flex-col gap-4 md:w-1/4 '>
                ...
                <div className='mt-auto flex-wrap gap-2 text-sm text-gray-600'>
                  <p>
                    Author:{' '}
              ...
              <div className='flex flex-1 flex-wrap gap-4 '>
                {currentProject.screenshots.map((screenshot, index) => (
                  <div
                    key={index}
                    className='relative h-[500px] w-full flex-1 flex-wrap'
                  >
                    {' '}
                    {/*  max-sm:h-[500px] add this in div to make screenshot show in smaller screens */}
                    <Image
                      src={screenshot}
